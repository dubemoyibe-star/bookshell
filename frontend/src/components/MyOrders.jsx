...
import {Clock, Package, Truck, XCircle, CheckCircle, ArrowLeft, CreditCard, DollarSign , ChevronDown, ChevronUp, X, MapPin} from 'lucide-react'
                ...
                <tbody className="divide-y divide-gray-200">
                  {sortedOrders.map((o) => (
                    <tr key={o._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 font-medium text-gray-900">
                        ₦{o.finalAmount.toLocaleString("en-NG", { minimumFractionDigits: 2 })}
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <button
                          ...
                          className="cursor-pointer px-3 py-1.5 bg-gradient-to-r from-[#1A237E] to-[#43C6AC] text-white rounded-lg text-xs hover:opacity-90 transition-opacity"
                        >
                          View Details
                        </button>
                      </td>
          ...
          <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                  ...
                  <div className="space-y-6">
                    {selectedOrder.book.map((book, i) => (
                      <div key={i} className="flex items-start space-x-4 border-b pb-4">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-gray-500 text-sm">
                            ₦{book.price.toLocaleString("en-NG", { minimumFractionDigits: 2 })} each
                          </p>
                        </div>
                      </div>
                    ))}
                    ...
                    <div className="pt-4 space-y-2">
                      {[
                        {
                          label: "Subtotal:",
                          value: `₦${selectedOrder.totalAmount.toLocaleString("en-NG", { minimumFractionDigits: 2 })}`,
                        },
                        {
                          label: "Shipping:",
                          value: `₦${selectedOrder.shippingCharge.toLocaleString("en-NG", { minimumFractionDigits: 2 })}`,
                        },
                        {
                          label: "Tax (5%):",
                          value: `₦${selectedOrder.taxAmount.toLocaleString("en-NG", { minimumFractionDigits: 2 })}`,
                        },
                        {
                          label: "Total:",
                          value: `₦${selectedOrder.finalAmount.toLocaleString("en-NG", { minimumFractionDigits: 2 })}`,
              ...
              <div className="border-t p-6 flex justify-end">
                <button
                  onClick={() => setSelectedOrder(null)}
                  className="cursor-pointer px-6 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300"
                >
                  Close
                </button>
              </div>
