...
const Checkout = () => {
  ...
  useEffect(() => {
    axios.get(`${API_BASE}/book`)
      ...
      .catch(err => console.error('Failed not load books images', err))
  }, [])
      ...
      <div className='py-4 lg:py-8 min-h-screen bg-gradient-to-br from-[#43C6AC] to-[#F8FFAE]'>
        <div className='conatiner mx-auto px-4 max-w-4xl'>
          ...
          className='bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center'>
            ...
            <div className='bg-gradient-to-r from-[#43C6AC]/10 to-[#F8FFAE]/10 rounded-xl p-4 mb-8 max-w-lg mx-auto'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-xl font-bold text-[#1A237E]'>₦{orderTotal.toLocaleString("en-NG", { minimumFractionDigits: 2 })}</span>
              </div>
            </div>

            <p className='text-gray-600 mb-8'>
              We've sent a comfirmation email to <span className='font-medium'>{formData.email}</span>.
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit}>
              <div className='mb-6'>
                <h3 className='text-lg font-semibold text-gray-800 mb-4 flex items-center '>
                  <MapPin className='w-5 h-5 mr-2 text-2xl text-[#43C6AC]'/>
                  Shipping Address
                </h3>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  {paymentMethods.map(method => (
                    <div key={method.id}>
                      ...
                      formData.paymentMethod === method.id ? 'border-[#43C6AC] bg-[#43C6AC]/10' : 'border-gray-300 hover:border-gray-400'}`}>
          ...
          className="bg-white rounded-2xl shadow-xl p-6 md:p-8 h-fit">
                    ...
                    cart.items.map(item => (
                      <div key={item.id} className="flex items-center">
                        ...
                        <div className="ml-4 text-right">
                          <p className="font-medium text-gray-900">₦{item.price.toLocaleString("en-NG", { minimumFractionDigits: 2 })}</p>
              ...
              <div className="flex justify-between items-center mb-8">
                ...
                <span className="text-xl font-bold text-[#1A237E]">₦{total.toLocaleString("en-NG", { minimumFractionDigits: 2 })}</span>
              </div>
