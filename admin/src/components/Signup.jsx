...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setToast({ visible: true, message: "Creating admin account...", type: "success" });

    try {
      await axios.post(`${API_BASE}/api/admin/register`, { name: username, email, password });
      setToast({ visible: true, message: "Admin account created successfully", type: "success" });
    } catch (error) {
      console.error(error);
      setToast({
        visible: true,
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Register a new admin for BookShell</p>
        </div>
